...
alter table tx_publisherdb_publishermakroitem_firstcomposer_person_mm rename to tx_mpdbcore_publisheditem_firstcomposer_gndperson_mm;
alter table tx_publisherdb_publishermakroitem_instrument_mm rename to tx_mpdbcore_publisheditem_gndinstrument_mm;
alter table tx_publisherdb_publishermakroitem_person_mm rename to tx_mpdbcore_publisheditem_gndperson_mm;
alter table tx_publisherdb_publishermakroitem_work_mm rename to tx_mpdbcore_publisheditem_gndwork_mm;
alter table tx_publisherdb_publishermikroitem_work_mm rename to tx_mpdbcore_publishedsubitem_gndwork_mm;
alter table tx_publisherdb_work_altinstrumentation_mvdbinstrumentation_mm rename to tx_dmont_gndwork_altmediumofperformance_mediumofperformance_mm;
...
alter table tx_publisherdb_work_mvdbgenre_mm rename to tx_dmont_gndwork_genre_mm;
